  ...
  return (
    <div>
      ...
      <div className="max-w-6xl mx-2 lg:mx-auto">
       ...
       {
        parcels.length>0 &&  <Card className="h-full w-full overflow-scroll lg:overflow-hidden">
        <table className="w-full min-w-max table-auto text-left">
          ...
          <tbody>
            {parcels.map(({ name, phoneNumber, bookingDate,requestedDeliveryDate,price,status }, index) => {
              ...
              return (
                <tr key={name}>
                  ...
                  <td className={classes}>
                    ...
                    >
                      <button><FaEdit className="text-xl"/></button>
                    </Typography>
                  </td>
                </tr>
              );
